...
const SCENE_CATALOG: Readonly<Record<SceneType, SceneCatalogEntry>> = Object.freeze({
  ...
  mall: defineCatalogEntry({
    type: 'mall',
    label: '商场',
    description: '聚焦楼层、店铺和服务设施，帮助用户尽快回到室内目标点位。',
    fields: [
      defineField({
        key: 'floor',
        label: '楼层',
        ...
        required: false,
        primary: true,
        description: '常见楼层可直接点选，特殊楼层写法也支持手填。',
        placeholder: '例如 3F、B1、LG',
        maxLength: 16,
      }),
      defineField({
        key: 'shop',
        ...
        required: false,
        primary: true,
        description: '店铺名称差异很大，直接输入最准确的店铺名或门牌。',
        placeholder: '例如 星巴克、MUJI、L3-021',
        maxLength: 40,
      }),
      defineField({
        key: 'facility',
        ...
        required: false,
        primary: true,
        description: '优先记录最容易帮助你回找的公共设施。',
        placeholder: '例如 服务台、扶梯旁、影院入口',
        maxLength: 24,
      }),
    ],
  }),
  hospital: defineCatalogEntry({
    ...
    fields: [
      ...
      defineField({
        ...
        required: false,
        primary: true,
        description: '优先记录分诊台、护士站、收费处等回找意义强的设施。',
  ...
  scenic_area: defineCatalogEntry({
    ...
    fields: [
      defineField({
        ...
        required: false,
        primary: true,
        description: '入口命名差异较大，既能点常用项，也能手动补充。',
        placeholder: '例如 南门、检票口、东游客中心入口',
        maxLength: 24,
      }),
      defineField({
        key: 'facility',
      ...
      defineField({
        ...
        placeholder: '例如 桥边、石阶旁、玻璃栈道第二平台',
        maxLength: 40,
      }),
    ],
  }),
